...
@Test4([Test3<String, C<String>>(Test1(40)), Test3<String, C<String>>(Test1(50)), Test3<String, C<String>>(Test1(60))])
...
@Test4([Test3<String, C<String>>(Test1(44)), Test3<String, C<String>>(Test1(55)), Test3<String, C<String>>(Test1(66))])
