 ...
 * @property omitFlagsInRenderedReferences If `true`, flags like `fake_override`, `inline` etc. are not printed in rendered declaration
 * references.
 */
data class DumpIrTreeOptions(
    ...
    val omitFlagsInRenderedReferences: Boolean = false,
)
