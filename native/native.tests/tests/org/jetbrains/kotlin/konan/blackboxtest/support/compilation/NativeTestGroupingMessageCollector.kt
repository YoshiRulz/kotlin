...
internal class NativeTestGroupingMessageCollector(
    ...
    // -memory-model and memoryModel flags are deprecated and will be removed later.
    // TODO: Do not set memoryModel from CI.
    private fun isMMFlagWarning(message: String): Boolean = message.startsWith(MM_FLAG_WARNING_PREFIX)
    ...
    companion object {
        ...
        private const val MM_FLAG_WARNING_PREFIX = "-memory-model and memoryModel switches are deprecated and will be removed in a future release."
