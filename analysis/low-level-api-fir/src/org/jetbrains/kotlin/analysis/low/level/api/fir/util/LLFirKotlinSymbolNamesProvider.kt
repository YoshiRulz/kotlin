...
import org.jetbrains.kotlin.fir.resolve.providers.FirDelegatingSymbolNamesCache
import org.jetbrains.kotlin.fir.resolve.providers.FirSymbolNamesCache
...
internal open class LLFirKotlinSymbolNamesProvider(
    ...
    companion object {
        fun cached(session: FirSession, declarationProvider: KotlinDeclarationProvider): FirSymbolNamesCache =
            FirDelegatingSymbolNamesCache(session, LLFirKotlinSymbolNamesProvider(declarationProvider))
    }
}
