...
internal class SymbolLightParameterForReceiver private constructor(
    ...
    private val _modifierList: PsiModifierList by lazyPub {
        SymbolLightClassModifierList(
            ...
            annotationsBox = if (forPropertyAnnotations) EmptyAnnotationsBox else GranularAnnotationsBox(
                ...
                additionalAnnotationsProvider = if (forPropertyAnnotations) EmptyAdditionalAnnotationsProvider else NullabilityAnnotationsProvider {
